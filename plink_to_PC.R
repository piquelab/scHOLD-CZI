...
fwrite(eigenvec2, sep='\t', quote=F, row.names=F, col.names=T, file=paste0(genofolder,"eigenvec_pc.txt"))
...
figfn <- paste0(figuredir,"1.1_pca.png")
...
figfn <- paste0(figuredir,"2.3_pca.png")
png(figfn, width=520, height=420, res=120)
print(p1)
dev.off()
...
figfn <- paste0(figuredir,"1.3_pca.png")
png(figfn, width=520, height=420, res=120)
print(p1)
dev.off()
